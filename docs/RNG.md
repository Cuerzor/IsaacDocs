...
设置种子时，推荐使用 shift index 35，这是大多数游戏内部函数采用的值。建议将该数字以 SHOUTING_SNAKE_CASE 常量形式记录，避免在程序中出现 [magic numbers](https://en.wikipedia.org/wiki/Magic_number_(programming))。
